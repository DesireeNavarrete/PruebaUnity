...
public class entregaPed1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (startCont)
        {
            ...
            //spawn de 2s al acabarse vida de un ped
            if (tiempoPed == 2)
            {
                if (pedidosActivos.Count < 4 && numPedidos > 0)
                {
        ...
        if (ped1.transform.childCount == 0 && tiempoPed == 2)
        {
            ...
            if (pedidosActivos.Count < 4)
            {
                print("añadido 2s vida out");
                startCont = false;
                tiempoPedF = 0;
                reinicioVida();
                lifeF1 = lifeF2;//mueve la vida al 1


            }
        }

        if (ped2.transform.childCount == 0 && tiempoPed == 2)
        {
            //pedidosActivos.RemoveAt(0);
            ...
            if (pedidosActivos.Count < 4)
            {
                ...
                tiempoPedF = 0;
                reinicioVida();
                lifeF2 = lifeF3;//mueve la vida al 2
        ...
        if (ped1.transform.childCount == 1)
        {
            ...
            if (ped1.GetComponentInChildren<Slider>().value == ped1.GetComponentInChildren<Slider>().maxValue)
            {
                ...
                //contador para spawnear otro pedido
        ...
        if (ped2.transform.childCount == 1)
        {
            ...
            //print(ped2.GetComponentInChildren<Slider>().value);
            ped2.transform.GetChild(0).GetComponentInChildren<Slider>().value=life2;
            print("1 hijo ped2");

            //pedidosActivos.RemoveAt(0);

      
            if (ped2.GetComponentInChildren<Slider>().value == ped2.GetComponentInChildren<Slider>().maxValue)
            {
        ...
        {
            //ped2.GetComponent<Animator>().SetBool("aparece", false);
            Destroy(ped1.transform.GetChild(0).gameObject);
            pedidosActivos.RemoveAt(0);

            //ped1.GetComponentInChildren<Slider>().value = rdn;
            print("2 hijos ped1");
        ...
        if (ped2.transform.childCount == 2)
        {
            ...
            //ped2.GetComponentInChildren<Slider>().value = rdn2;
            print("2 hijos ped2");
        ...
        if (pedidosActivos.Count >=1)
        {
            ...
            if (pedidosActivos[0]=="objV" && !ped1.transform.Find("pedidoObjV(Clone)"))
            {
                ...
                //v.GetComponent<Slider>().maxValue = rdn;
                //ped1.transform.GetChild(0).GetComponent<Slider>().maxValue = rdn;

                if (!ped1.transform.Find("pedidoObjR(Clone)"))
                {
                    GameObject v = Instantiate(ui_objV) as GameObject;
                    v.transform.SetParent(ped1.transform, false);
                    print("inst1");
                ...
                if (ped1.GetComponentInChildren<Slider>().maxValue == 40)
                {
                    print(" qw  qw");
                }
            ...
            if (pedidosActivos[0] == "objR" && !ped1.transform.Find("pedidoObjR(Clone)"))
            {
                ...
                //r.GetComponent<Slider>().maxValue = rdn;
                //ped1.transform.GetChild(0).GetComponent<Slider>().maxValue = rdn;
            ...
            if (pedidosActivos[0] == "objA")
            {

             

                if (!ped1.transform.Find("pedidoObjA(Clone)"))
                {
                ...
                //a.GetComponent<Slider>().maxValue = rdn;
                //ped1.transform.GetChild(0).GetComponent<Slider>().maxValue = rdn;
    ...
    private void OnCollisionEnter(Collision col)
    {
        ...
        if (col.transform.tag == "objetos")
        {
            ...
            if (pedidosActivos.Contains(coli))
            {
                ...
                //cuando se entregue el primer pedido, que empiece el contador (start=true)
            ...
            {
                //ped1.GetComponent<Animator>().SetBool("aparece", false);
                //ped1.GetComponent<Animator>().SetBool("desaparece", true);
                print("hi");
                ...
                //vida
                //ped2.GetComponentInChildren<Slider>().value == 30
