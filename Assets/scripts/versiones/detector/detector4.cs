...
public class detector4 : MonoBehaviour
{
/*---------------------------AÑADIR/ARREGLAR-------------------------------------
 ...
 *          falla al coger uno azul e ir a la caja roja a soltarlo, ahi lo instancia
 * 
 * 
 * 
 */
    ...
    void Update()
    {
        ...
        print(objetos.colCajasObj.Count);
    }
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.transform.tag == "cajaV")
        {
            ...
            if (Input.GetButtonDown("Submit") && !cogido)
            {
                ...
                if (objetos.colCajasObj.Contains(col)==false)
                {
