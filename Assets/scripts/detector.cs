...
public class detector : MonoBehaviour
{
    ...
    public bool   playerMesa, entregaTrg, cogido, paraCoger;
    public static bool playerPlato, playerObj, colBasura, datafono;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //si tiene cogido el datafono y la mesaCli colisiona con el player
        if (gameObject.transform.Find("datafono"))
        {
            print("datafonito");
            //datafono = true;
            //gameObject.transform.Find("datafono").position = pos.transform.position ;
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        //cuando el jugador vaya a la mesa del cliente a cobrar, que no suelte el datafono
        /*if (other.transform.name=="mesaCli")
        {
            mesaCli = true;
        }
        else
        ...
        if (other.transform.tag == "cajaAma")
        {
            ...
            //instancia sin nada cogido
            //if (Input.GetButtonDown("Submit") || CrossPlatformInputManager.GetButtonDown("Submit") && !cogido && gameObject.transform.childCount == 0)
            if (CrossPlatformInputManager.GetButtonDown("Submit") && !cogido && gameObject.transform.childCount == 0)
            {
        ...
        if (other.transform.tag == "objetos")
        {
            ...
            if (CrossPlatformInputManager.GetButtonDown("Submit") && !cogido && paraCoger && playerMesa && platosPlayer.Count==0)
            {
            ...
            if (CrossPlatformInputManager.GetButtonDown("Submit") && !cogido && paraCoger)//va mejor que los demas
            {
            ...
            if (CrossPlatformInputManager.GetButtonDown("Submit") && cogido && !paraCoger && objsPlayer.Count ==1 && !colBasura && !entregaTrg)
            {
                //print("no mesilla");
            ...
            if (CrossPlatformInputManager.GetButtonDown("Submit") && colBasura){
        ...
        if (other.transform.tag == "mesa")
        {
            ...
            if(hijo!="plato")
            {
                ...
                if (CrossPlatformInputManager.GetButtonDown("Submit") && cogido && !paraCoger && gameObject.transform.parent != null)
                {
                    //entra si la mesa no tiene nada encima
                    //if (objsPlayer.Count<2)
                    if (!objetos.colCajasObj.Contains(col5))
                    {
        ...
        if (other.transform.tag == "plato")
        {
           ...
           if (CrossPlatformInputManager.GetButtonDown("Submit") && !cogido && paraCoger && plato.colPlatos.Count>0 && objsPlayer.Count>0)
           {
            ...
            if (CrossPlatformInputManager.GetButtonDown("Submit") && !cogido && paraCoger && objsPlayer.Count==0)
            {
                print("coge plato");
                other.transform.SetParent(gameObject.transform);
                other.GetComponent<Rigidbody>().isKinematic = true;
            ...
            //if (Input.GetButtonDown("Submit") && cogido && !paraCoger && playerPlato && !colBasura)
            if (CrossPlatformInputManager.GetButtonDown("Submit") && cogido && !paraCoger && playerPlato && !colBasura)
            {
                //print("suelo");
            ...
            //if (Input.GetButtonDown("Submit") && cogido && !paraCoger && playerPlato)
            if (CrossPlatformInputManager.GetButtonDown("Submit") && cogido && !paraCoger && playerPlato)
            {
       ...
       // if (Input.GetButtonDown("Submit") && (other.transform.tag=="cajaA" || other.transform.tag == "cajaV" || other.transform.tag == "cajaR" || other.transform.tag == "mesa") && transform.Find("plato"))
        if (CrossPlatformInputManager.GetButtonDown("Submit") && (other.transform.tag=="cajaA" || other.transform.tag == "cajaV" || other.transform.tag == "cajaR" || other.transform.tag == "mesa") && transform.Find("plato"))
        {
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        //si tiene cogido el datafono y la mesaCli colisiona con el player, lo añade a la lista de colision
        if (gameObject.transform.Find("datafono"))
        {
            print("datafonito bye");
